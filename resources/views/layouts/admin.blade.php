...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/logo3.png') }}"/>
    <link rel="icon" href="{{ asset('assets/img/logo3.png" type="image/png') }}" sizes="16x16">
...
<aside class="admin-sidebar">
    <div class="admin-sidebar-brand">
        ...
        <img class="admin-brand-logo" src="{{ asset('assets/img/logo3.png') }}" width="40" alt="Tracking">
        <span class="admin-brand-content"><a href="index.html">  Tracking</a></span>
